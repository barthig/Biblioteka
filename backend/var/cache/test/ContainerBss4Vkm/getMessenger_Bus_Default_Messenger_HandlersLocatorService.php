...
class getMessenger_Bus_Default_Messenger_HandlersLocatorService extends App_KernelTestContainer
{
    ...
    {
        return $container->privates['messenger.bus.default.messenger.handlers_locator'] = new \Symfony\Component\Messenger\Handler\HandlersLocator(['App\\Message\\ReservationQueuedNotification' => new RewindableGenerator(function () use ($container) {
