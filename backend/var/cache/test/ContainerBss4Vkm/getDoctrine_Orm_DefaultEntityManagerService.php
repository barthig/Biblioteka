...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelTestContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhostFd3fb53', static fn () => \EntityManagerGhostFd3fb53::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
