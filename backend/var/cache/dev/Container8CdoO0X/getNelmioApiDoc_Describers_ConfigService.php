...
class getNelmioApiDoc_Describers_ConfigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_api_doc.describers.config'] = new \Nelmio\ApiDocBundle\Describer\ExternalDocDescriber(['info' => ['title' => 'Biblioteka API', 'description' => 'OpenAPI specification for the Biblioteka platform', 'version' => '1.1.0'], 'servers' => [['url' => 'http://127.0.0.1:8000', 'description' => 'Lokalny serwer deweloperski']], 'components' => ['securitySchemes' => ['BearerAuth' => ['type' => 'http', 'scheme' => 'bearer', 'bearerFormat' => 'JWT'], 'ApiSecret' => ['type' => 'apiKey', 'in' => 'header', 'name' => 'X-API-SECRET']]], 'security' => [['BearerAuth' => []], ['ApiSecret' => []]]]);
    }
}
