...
CREATE TABLE acquisition_budget (id INT NOT NULL, name VARCHAR(160) NOT NULL, fiscal_year VARCHAR(9) NOT NULL, allocated_amount NUMERIC(12, 2) NOT NULL, spent_amount NUMERIC(12, 2) NOT NULL, currency VARCHAR(3) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE acquisition_expense (id INT NOT NULL, budget_id INT NOT NULL, order_id INT DEFAULT NULL, amount NUMERIC(12, 2) NOT NULL, currency VARCHAR(3) NOT NULL, description VARCHAR(255) NOT NULL, type VARCHAR(20) NOT NULL, posted_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE acquisition_order (id INT NOT NULL, supplier_id INT NOT NULL, budget_id INT DEFAULT NULL, reference_number VARCHAR(120) DEFAULT NULL, title VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, items JSON DEFAULT NULL, total_amount NUMERIC(12, 2) NOT NULL, currency VARCHAR(3) NOT NULL, status VARCHAR(20) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ordered_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, expected_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, received_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, cancelled_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id));
...
CREATE TABLE announcement (id INT NOT NULL, created_by_id INT NOT NULL, title VARCHAR(255) NOT NULL, content TEXT NOT NULL, type VARCHAR(20) NOT NULL, status VARCHAR(20) NOT NULL, is_pinned BOOLEAN NOT NULL, show_on_homepage BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, published_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, target_audience JSON DEFAULT NULL, PRIMARY KEY(id));
...
COMMENT ON COLUMN announcement.published_at IS '(DC2Type:datetime_immutable)';
COMMENT ON COLUMN announcement.expires_at IS '(DC2Type:datetime_immutable)';
...
CREATE TABLE backup_record (id INT NOT NULL, file_name VARCHAR(190) NOT NULL, file_path VARCHAR(255) NOT NULL, file_size INT NOT NULL, status VARCHAR(32) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, initiated_by VARCHAR(120) DEFAULT NULL, PRIMARY KEY(id));
COMMENT ON COLUMN backup_record.created_at IS '(DC2Type:datetime_immutable)';
CREATE TABLE book (id INT NOT NULL, author_id INT NOT NULL, title VARCHAR(255) NOT NULL, isbn VARCHAR(20) DEFAULT NULL, copies INT NOT NULL, total_copies INT NOT NULL, storage_copies INT NOT NULL, open_stack_copies INT NOT NULL, description TEXT DEFAULT NULL, publisher VARCHAR(180) DEFAULT NULL, publication_year SMALLINT DEFAULT NULL, resource_type VARCHAR(60) DEFAULT NULL, signature VARCHAR(60) DEFAULT NULL, target_age_group VARCHAR(24) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE book_copy (id INT NOT NULL, book_id INT NOT NULL, inventory_code VARCHAR(60) NOT NULL, status VARCHAR(20) NOT NULL, location VARCHAR(120) DEFAULT NULL, access_type VARCHAR(30) NOT NULL, condition_state VARCHAR(120) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE book_digital_asset (id INT NOT NULL, book_id INT NOT NULL, label VARCHAR(255) NOT NULL, original_filename VARCHAR(255) NOT NULL, mime_type VARCHAR(100) NOT NULL, size INT NOT NULL, storage_name VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE category (id INT NOT NULL, name VARCHAR(120) NOT NULL, PRIMARY KEY(id));
CREATE UNIQUE INDEX UNIQ_64C19C15E237E06 ON category (name);
CREATE TABLE favorite (id INT NOT NULL, user_id INT NOT NULL, book_id INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE fine (id INT NOT NULL, loan_id INT NOT NULL, amount NUMERIC(8, 2) NOT NULL, currency VARCHAR(3) NOT NULL, reason VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, paid_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id));
...
CREATE TABLE integration_config (id INT NOT NULL, name VARCHAR(160) NOT NULL, provider VARCHAR(120) NOT NULL, enabled BOOLEAN NOT NULL, settings JSON NOT NULL, last_status VARCHAR(32) NOT NULL, last_tested_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE loan (id INT NOT NULL, book_id INT NOT NULL, book_copy_id INT DEFAULT NULL, user_id INT NOT NULL, borrowed_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, due_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, returned_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, extensions_count INT NOT NULL, last_extended_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id));
...
CREATE TABLE notification_log (id INT NOT NULL, user_id INT NOT NULL, type VARCHAR(64) NOT NULL, channel VARCHAR(32) NOT NULL, fingerprint VARCHAR(96) NOT NULL, payload JSON DEFAULT NULL, status VARCHAR(32) NOT NULL, error_message VARCHAR(255) DEFAULT NULL, sent_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE refresh_token (id INT NOT NULL, user_id INT NOT NULL, token VARCHAR(255) NOT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ip_address VARCHAR(45) DEFAULT NULL, user_agent VARCHAR(255) DEFAULT NULL, is_revoked BOOLEAN NOT NULL, revoked_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id));
...
CREATE TABLE registration_token (id INT NOT NULL, user_id INT NOT NULL, token VARCHAR(96) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, used_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id));
...
CREATE TABLE reservation (id INT NOT NULL, book_id INT NOT NULL, book_copy_id INT DEFAULT NULL, user_id INT NOT NULL, status VARCHAR(20) NOT NULL, reserved_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, fulfilled_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, cancelled_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id));
...
CREATE TABLE review (id INT NOT NULL, book_id INT NOT NULL, user_id INT NOT NULL, rating SMALLINT NOT NULL, comment TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE staff_role (id INT NOT NULL, name VARCHAR(120) NOT NULL, role_key VARCHAR(120) NOT NULL, modules JSON NOT NULL, description VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE system_setting (id INT NOT NULL, setting_key VARCHAR(120) NOT NULL, setting_value TEXT NOT NULL, value_type VARCHAR(16) NOT NULL, description VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE app_user (id INT NOT NULL, email VARCHAR(180) NOT NULL, name VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, phone_number VARCHAR(30) DEFAULT NULL, address_line VARCHAR(255) DEFAULT NULL, city VARCHAR(120) DEFAULT NULL, postal_code VARCHAR(12) DEFAULT NULL, blocked BOOLEAN DEFAULT false NOT NULL, verified BOOLEAN DEFAULT false NOT NULL, verified_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, pending_approval BOOLEAN DEFAULT false NOT NULL, membership_group VARCHAR(64) DEFAULT 'standard' NOT NULL, loan_limit INT DEFAULT 5 NOT NULL, blocked_reason VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, privacy_consent_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, newsletter_subscribed BOOLEAN DEFAULT true NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE weeding_record (id INT NOT NULL, book_id INT NOT NULL, book_copy_id INT DEFAULT NULL, processed_by_id INT DEFAULT NULL, reason VARCHAR(255) NOT NULL, action VARCHAR(20) NOT NULL, condition_state VARCHAR(120) DEFAULT NULL, notes TEXT DEFAULT NULL, removed_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id));
...
ALTER TABLE refresh_token ADD CONSTRAINT FK_C74F2195A76ED395 FOREIGN KEY (user_id) REFERENCES app_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
