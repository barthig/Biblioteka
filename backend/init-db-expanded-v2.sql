...
-- Dodatkowi autorzy realnie wystepujacy w zbiorach
INSERT INTO author (id, name) VALUES
(31, 'Fiodor Dostojewski'),
(32, 'Michail Bulhakow'),
(33, 'George R.R. Martin'),
(34, 'Antoine de Saint-Exupery'),
(35, 'Carlos Ruiz Zafon'),
(36, 'Madeline Miller'),
(37, 'Delia Owens'),
(38, 'Bonnie Garmus'),
(39, 'Sally Rooney'),
...
-- Dodatkowe realne tytuly
INSERT INTO book (id, title, isbn, author_id, copies, total_copies, storage_copies, open_stack_copies, description, publisher, publication_year, resource_type, signature, target_age_group, created_at, updated_at) VALUES
(31, 'Maly Ksiaze', NULL, 34, 3, 3, 1, 2, 'Klasyczna opowiesc filozoficzna o przyjazni, odpowiedzialnosci i patrzeniu sercem.', 'Muza', 1943, 'Ksiazka drukowana', 'L-SAI-001', 'child', NOW(), NOW()),
(32, 'Cien wiatru', NULL, 35, 3, 3, 1, 2, 'Barcelona po wojnie, tajemnicza ksiazka i historia Daniela Sempere.', 'Muza', 2001, 'Ksiazka drukowana', 'L-ZAF-001', 'adult', NOW(), NOW()),
(33, 'Piesn Achillesa', NULL, 36, 2, 2, 1, 1, 'Retelling mitu trojanskiego opowiedziany z perspektywy Patroklosa.', 'Albatros', 2011, 'Ksiazka drukowana', 'F-MIL-001', 'adult', NOW(), NOW()),
(34, 'Gdzie spiewaja raki', NULL, 37, 4, 4, 1, 3, 'Powiesc obyczajowo-kryminalna o dorastaniu Ky na mokradlach Karoliny Polnocnej.', 'Czwarta Strona', 2018, 'Ksiazka drukowana', 'L-OWE-001', 'adult', NOW(), NOW()),
(35, 'Lekcje chemii', NULL, 38, 3, 3, 1, 2, 'Historia chemiczki Elizabeth Zott i przewrotnej kariery telewizyjnej.', 'Marginesy', 2022, 'Ksiazka drukowana', 'L-GAR-001', 'adult', NOW(), NOW()),
(36, 'Normalni ludzie', NULL, 39, 2, 2, 1, 1, 'Wspolczesna powiesc o relacji Marianne i Connella.', 'WAB', 2018, 'Ksiazka drukowana', 'L-ROO-001', 'adult', NOW(), NOW()),
(37, 'Babel', NULL, 40, 3, 3, 1, 2, 'Powiesc o jezyku, kolonializmie i mocy srebra w alternatywnym Oksfordzie.', 'Fabryka Slow', 2022, 'Ksiazka drukowana', 'F-KUA-001', 'adult', NOW(), NOW()),
(38, 'Bracia Karamazow', NULL, 31, 3, 3, 2, 1, 'Monumentalna powiesc o rodzinie, wierze, winie i odpowiedzialnosci.', 'Znak', 1880, 'Ksiazka drukowana', 'L-DOS-001', 'adult', NOW(), NOW()),
(39, 'Biala gwardia', NULL, 32, 2, 2, 1, 1, 'Powiesc o rodzinie Turbinow na tle wojny domowej w Kijowie.', 'Czytelnik', 1925, 'Ksiazka drukowana', 'L-BUL-001', 'adult', NOW(), NOW()),
(40, 'Starcie krolow', NULL, 33, 4, 4, 1, 3, 'Drugi tom cyklu Piesn lodu i ognia o walce o Zelazny Tron.', 'Zysk i S-ka', 1998, 'Ksiazka drukowana', 'F-MAR-001', 'adult', NOW(), NOW());

-- Kolejna partia realnych tytulow do lacznie 100 ksiazek
INSERT INTO book (id, title, isbn, author_id, copies, total_copies, storage_copies, open_stack_copies, description, publisher, publication_year, resource_type, signature, target_age_group, created_at, updated_at) VALUES
(41, 'Emma', NULL, 15, 1, 2, 0, 1, 'Klasyczna powiesc obyczajowa Jane Austen o dojrzewaniu i pomylkach serca.', 'Penguin Classics', 1815, 'Ksiazka drukowana', 'L-AUS-002', 'adult', NOW(), NOW()),
(42, 'Harry Potter i Komnata Tajemnic', NULL, 8, 1, 2, 0, 1, 'Drugi rok Harryego w Hogwarcie i tajemnica ukryta w zamku.', 'Media Rodzina', 1998, 'Ksiazka drukowana', 'F-ROW-002', 'teen', NOW(), NOW()),
(43, 'Harry Potter i Wiezien Azkabanu', NULL, 8, 1, 2, 0, 1, 'Trzeci tom o Harrym Potterze z uciekinierem z Azkabanu.', 'Media Rodzina', 1999, 'Ksiazka drukowana', 'F-ROW-003', 'teen', NOW(), NOW()),
(44, 'Hobbit', NULL, 22, 1, 2, 0, 1, 'Przygoda Bilba Bagginsa w drodze do Samotnej Gory.', 'Muza', 1937, 'Ksiazka drukowana', 'F-TOL-002', 'teen', NOW(), NOW()),
(45, 'Mesjasz Diuny', NULL, 23, 1, 2, 0, 1, 'Kontynuacja historii Paula Atrydy na Arrakis.', 'Rebis', 1969, 'Ksiazka drukowana', 'SF-HER-002', 'adult', NOW(), NOW()),
(46, 'Testamenty', NULL, 18, 1, 2, 0, 1, 'Powiesc osadzona w uniwersum Gileadu wiele lat po Opowiesci podręcznej.', 'Wielka Litera', 2019, 'Ksiazka drukowana', 'L-ATW-002', 'adult', NOW(), NOW()),
(47, 'I nie bylo juz nikogo', NULL, 12, 1, 2, 0, 1, 'Klasyczny kryminal z grupa nieznajomych odcietych na wyspie.', 'Wydawnictwo Dolnoslaskie', 1939, 'Ksiazka drukowana', 'K-CHR-002', 'adult', NOW(), NOW()),
(48, 'To', NULL, 11, 1, 2, 0, 1, 'Powieść grozy o miasteczku Derry i złu wracającym po latach.', 'Albatros', 1986, 'Ksiazka drukowana', 'H-KIN-002', 'adult', NOW(), NOW()),
(49, 'Kafka nad morzem', NULL, 13, 1, 2, 0, 1, 'Oniryczna powiesc o ucieczce, przeznaczeniu i samotnosci.', 'Muza', 2002, 'Ksiazka drukowana', 'L-MUR-002', 'adult', NOW(), NOW()),
(50, 'Wahadlo Foucaulta', NULL, 26, 1, 2, 0, 1, 'Intelektualny thriller o spiskach, symbolach i interpretacjach.', 'Noir Sur Blanc', 1988, 'Ksiazka drukowana', 'T-ECO-002', 'adult', NOW(), NOW()),
(51, 'Anioly i demony', NULL, 27, 1, 2, 0, 1, 'Thriller o tajnym stowarzyszeniu i zagrozeniu dla Watykanu.', 'Sonia Draga', 2000, 'Ksiazka drukowana', 'T-BRO-002', 'adult', NOW(), NOW()),
(52, 'Homo Deus', NULL, 29, 1, 2, 0, 1, 'Esej o mozliwych kierunkach rozwoju ludzkosci w przyszlosci.', 'Literackie', 2015, 'Ksiazka drukowana', 'NF-HAR-002', 'adult', NOW(), NOW()),
(53, 'Bajki robotow', NULL, 3, 1, 2, 0, 1, 'Zbior opowiesci o maszynach, konstruktorach i kosmicznych krainach.', 'Wydawnictwo Literackie', 1964, 'Ksiazka drukowana', 'SF-LEM-002', 'teen', NOW(), NOW()),
(54, 'Prowadz swoj plug przez kosci umarlych', NULL, 2, 1, 2, 0, 1, 'Powieść łącząca kryminał, filozofię i ekologiczny niepokoj.', 'Wydawnictwo Literackie', 2009, 'Ksiazka drukowana', 'K-TOK-002', 'adult', NOW(), NOW()),
(55, 'Krew elfow', NULL, 1, 1, 2, 0, 1, 'Pierwszy tom sagi o wiedźminie poświęcony losom Ciri.', 'SuperNOWA', 1994, 'Ksiazka drukowana', 'F-SAP-002', 'teen', NOW(), NOW()),
(56, 'Nigdziebadz', NULL, 17, 1, 2, 0, 1, 'Mroczna fantastyka miejska pod ulicami Londynu.', 'Mag', 1996, 'Ksiazka drukowana', 'F-GAI-002', 'adult', NOW(), NOW()),
(57, 'Z mgly zrodzony', NULL, 16, 1, 2, 0, 1, 'Powieść fantasy o alomancji i walce z imperium Ostatniego Wladcy.', 'Mag', 2006, 'Ksiazka drukowana', 'F-SAN-002', 'teen', NOW(), NOW()),
(58, 'Kolor magii', NULL, 19, 1, 2, 0, 1, 'Pierwsza powiesc ze Swiata Dysku.', 'Prószyński i S-ka', 1983, 'Ksiazka drukowana', 'F-PRA-002', 'teen', NOW(), NOW()),
(59, 'Lewa reka ciemnosci', NULL, 20, 1, 2, 0, 1, 'Klasyka SF o kulturze, plci i spotkaniu z Innym.', 'Prószyński i S-ka', 1969, 'Ksiazka drukowana', 'SF-LEG-002', 'adult', NOW(), NOW()),
(60, 'Ja, robot', NULL, 10, 1, 2, 0, 1, 'Zbior opowiadan o robotyce i trzech prawach robotow.', 'Zysk i S-ka', 1950, 'Ksiazka drukowana', 'SF-ASI-002', 'teen', NOW(), NOW()),
(61, 'Folwark zwierzecy', NULL, 9, 1, 2, 0, 1, 'Satyra polityczna o wladzy, propagandzie i rewolucji.', 'Muza', 1945, 'Ksiazka drukowana', 'L-ORW-002', 'teen', NOW(), NOW()),
(62, 'Dzuma', NULL, 24, 1, 2, 0, 1, 'Powieść o epidemii, absurdzie i ludzkiej solidarności.', 'PIW', 1947, 'Ksiazka drukowana', 'L-CAM-002', 'adult', NOW(), NOW()),
(63, 'Stary czlowiek i morze', NULL, 14, 1, 2, 0, 1, 'Krótka powiesc o wytrwalosci i godnosci w obliczu porazki.', 'Scribner', 1952, 'Ksiazka drukowana', 'L-HEM-002', 'teen', NOW(), NOW()),
(64, 'Rozwazna i romantyczna', NULL, 15, 1, 2, 0, 1, 'Klasyczna powiesc o siostrach Dashwood i milosnych wyborach.', 'Penguin Classics', 1811, 'Ksiazka drukowana', 'L-AUS-003', 'adult', NOW(), NOW()),
(65, 'Morderstwo na plebanii', NULL, 12, 1, 2, 0, 1, 'Jedna z pierwszych zagadek rozwiazywanych przez pannę Marple.', 'Wydawnictwo Dolnoslaskie', 1930, 'Ksiazka drukowana', 'K-CHR-003', 'adult', NOW(), NOW()),
(66, 'Smetarz dla zwierzakow', NULL, 11, 1, 2, 0, 1, 'Powieść grozy o stracie, zalu i niebezpiecznym pragnieniu cofania smierci.', 'Albatros', 1983, 'Ksiazka drukowana', 'H-KIN-003', 'adult', NOW(), NOW()),
(67, '1Q84', NULL, 13, 1, 2, 0, 1, 'Obszerna powiesc o alternatywnej rzeczywistosci, przemocy i milosci.', 'Muza', 2009, 'Ksiazka drukowana', 'L-MUR-003', 'adult', NOW(), NOW()),
(68, 'Nawalnica mieczy', NULL, 33, 1, 2, 0, 1, 'Trzeci tom sagi fantasy o Westeros i wojnie pieciu krolow.', 'Zysk i S-ka', 2000, 'Ksiazka drukowana', 'F-MAR-002', 'adult', NOW(), NOW()),
(69, 'Gra aniola', NULL, 35, 1, 2, 0, 1, 'Mroczna powiesc o ksiazkach, Barcelonie i niebezpiecznej umowie.', 'Muza', 2008, 'Ksiazka drukowana', 'T-ZAF-002', 'adult', NOW(), NOW()),
(70, 'Kirke', NULL, 36, 1, 2, 0, 1, 'Mitologiczna opowiesc o czarodziejce z wyspy Ajaja.', 'Albatros', 2018, 'Ksiazka drukowana', 'F-MIL-002', 'adult', NOW(), NOW()),
(71, 'Rozmowy z przyjaciolmi', NULL, 39, 1, 2, 0, 1, 'Debiutancka powiesc o relacjach, bliskosci i emocjonalnej zaleznosci.', 'WAB', 2017, 'Ksiazka drukowana', 'L-ROO-002', 'adult', NOW(), NOW()),
(72, 'Yellowface', NULL, 40, 1, 2, 0, 1, 'Wspolczesna satyra o rynku wydawniczym, plagiacie i tozsamosci.', 'Vesper', 2023, 'Ksiazka drukowana', 'T-KUA-002', 'adult', NOW(), NOW()),
(73, 'Idiota', NULL, 31, 1, 2, 0, 1, 'Powieść o ksieciu Myszkinie, dobroci i zderzeniu ideału z rzeczywistoscia.', 'Znak', 1869, 'Ksiazka drukowana', 'L-DOS-002', 'adult', NOW(), NOW()),
(74, 'Fatalne jaja', NULL, 32, 1, 2, 0, 1, 'Groteskowa satyra science fiction o eksperymencie wymykającym sie spod kontroli.', 'Czytelnik', 1925, 'Ksiazka drukowana', 'SF-BUL-002', 'adult', NOW(), NOW()),
(75, 'Ziemia planeta ludzi', NULL, 34, 1, 2, 0, 1, 'Eseistyczna proza o lataniu, odpowiedzialnosci i ludzkiej wspolnocie.', 'Muza', 1939, 'Ksiazka drukowana', 'R-SAI-002', 'adult', NOW(), NOW()),
(76, 'Koniec wiecznosci', NULL, 10, 1, 2, 0, 1, 'Powieść o podrózach w czasie i skutkach manipulowania historia.', 'Zysk i S-ka', 1955, 'Ksiazka drukowana', 'SF-ASI-003', 'adult', NOW(), NOW()),
(77, 'Ubik', NULL, 21, 1, 2, 0, 1, 'Powieść Philipa K. Dicka o niestabilnej rzeczywistosci i ontologicznym niepokoju.', 'Rebis', 1969, 'Ksiazka drukowana', 'SF-DIC-002', 'adult', NOW(), NOW()),
(78, 'Dwie wieze', NULL, 22, 1, 2, 0, 1, 'Drugi tom Wladcy Pierscieni.', 'Muza', 1954, 'Ksiazka drukowana', 'F-TOL-003', 'teen', NOW(), NOW()),
(79, 'Powrot krola', NULL, 22, 1, 2, 0, 1, 'Final trylogii o wyprawie do Mordoru i wojnie o Gondor.', 'Muza', 1955, 'Ksiazka drukowana', 'F-TOL-004', 'teen', NOW(), NOW()),
(80, 'Dzieci Diuny', NULL, 23, 1, 2, 0, 1, 'Trzeci tom sagi o Arrakis i rodzie Atrydow.', 'Rebis', 1976, 'Ksiazka drukowana', 'SF-HER-003', 'adult', NOW(), NOW()),
(81, 'Wiezien nieba', NULL, 35, 1, 2, 0, 1, 'Kolejna historia z Cmentarza Zapomnianych Ksiazek.', 'Muza', 2011, 'Ksiazka drukowana', 'T-ZAF-003', 'adult', NOW(), NOW()),
(82, '21 lekcji na XXI wiek', NULL, 29, 1, 2, 0, 1, 'Zbior esejow o wyzwaniach wspolczesnego swiata.', 'Literackie', 2018, 'Ksiazka drukowana', 'NF-HAR-003', 'adult', NOW(), NOW()),
(83, 'Obcy', NULL, 24, 1, 2, 0, 1, 'Jedna z najwazniejszych powiesci egzystencjalnych XX wieku.', 'PIW', 1942, 'Ksiazka drukowana', 'L-CAM-003', 'adult', NOW(), NOW()),
(84, 'Potop', NULL, 6, 1, 2, 0, 1, 'Historyczna epopeja o wojnie ze Szwecja i losach Kmicica.', 'Czytelnik', 1886, 'Ksiazka drukowana', 'H-SIE-002', 'teen', NOW(), NOW()),
(85, 'Ogniem i mieczem', NULL, 6, 1, 2, 0, 1, 'Pierwsza czesc Trylogii rozgrywajaca sie w czasach powstania Chmielnickiego.', 'Czytelnik', 1884, 'Ksiazka drukowana', 'H-SIE-003', 'teen', NOW(), NOW()),
(86, 'Dolina Issy', NULL, 7, 1, 2, 0, 1, 'Powieść o dziecinstwie, pamieci i krajobrazie Litwy.', 'Znak', 1955, 'Ksiazka drukowana', 'L-MIL-002', 'adult', NOW(), NOW()),
(87, 'Chwila', NULL, 5, 1, 2, 0, 1, 'Tom poezji Wislawy Szymborskiej z konca lat dziewiecdziesiatych.', 'Znak', 2002, 'Ksiazka drukowana', 'P-SZY-002', 'adult', NOW(), NOW()),
(88, 'Heban', NULL, 4, 1, 2, 0, 1, 'Zbior reportazy Ryszarda Kapuscinskiego o Afryce.', 'Czytelnik', 1998, 'Ksiazka drukowana', 'R-KAP-002', 'adult', NOW(), NOW()),
(89, 'Eichmann w Jerozolimie', NULL, 30, 1, 2, 0, 1, 'Esej o procesie Eichmanna i banalnosci zla.', 'Znak', 1963, 'Ksiazka drukowana', 'F-ARE-002', 'adult', NOW(), NOW()),
(90, 'Czarnoksieznik z Archipelagu', NULL, 20, 1, 2, 0, 1, 'Klasyczna fantasy o Gedzie, mocy imion i dojrzewaniu.', 'Prószyński i S-ka', 1968, 'Ksiazka drukowana', 'F-LEG-003', 'teen', NOW(), NOW()),
(91, 'Koralina', NULL, 17, 1, 2, 0, 1, 'Mroczna basn o dziewczynce przechodzacej do drugiego domu.', 'Mag', 2002, 'Ksiazka drukowana', 'D-GAI-003', 'child', NOW(), NOW()),
(92, 'Harry Potter i Czara Ognia', NULL, 8, 1, 2, 0, 1, 'Czwarty rok Harryego i Turniej Trojmagiczny.', 'Media Rodzina', 2000, 'Ksiazka drukowana', 'F-ROW-004', 'teen', NOW(), NOW()),
(93, 'Droga krolow', NULL, 16, 1, 2, 0, 1, 'Pierwszy tom Archiwum Burzowego Swiatla.', 'Mag', 2010, 'Ksiazka drukowana', 'F-SAN-003', 'adult', NOW(), NOW()),
(94, 'Mort', NULL, 19, 1, 2, 0, 1, 'Humorystyczna fantasy o terminowaniu u Smierci.', 'Prószyński i S-ka', 1987, 'Ksiazka drukowana', 'F-PRA-003', 'teen', NOW(), NOW()),
(95, 'Alias Grace', NULL, 18, 1, 2, 0, 1, 'Powieść inspirowana prawdziwa historia skazanej sluzacej.', 'Wielka Litera', 1996, 'Ksiazka drukowana', 'L-ATW-003', 'adult', NOW(), NOW()),
(96, 'Cmentarz w Pradze', NULL, 26, 1, 2, 0, 1, 'Thriller historyczny o falszerstwach, spiskach i antysemityzmie.', 'Noir Sur Blanc', 2010, 'Ksiazka drukowana', 'T-ECO-003', 'adult', NOW(), NOW()),
(97, 'Inferno', NULL, 27, 1, 2, 0, 1, 'Thriller sensacyjny z Robertem Langdonem w roli glownej.', 'Sonia Draga', 2013, 'Ksiazka drukowana', 'T-BRO-003', 'adult', NOW(), NOW()),
(98, 'Smierc na Nilu', NULL, 12, 1, 2, 0, 1, 'Kryminal z Herkulesem Poirot rozgrywajacy sie podczas rejsu po Nilu.', 'Wydawnictwo Dolnoslaskie', 1937, 'Ksiazka drukowana', 'K-CHR-004', 'adult', NOW(), NOW()),
(99, 'Bieguni', NULL, 2, 1, 2, 0, 1, 'Nagrodzona powiesc o podrozach, ruchu i nowoczesnej tozsamosci.', 'Wydawnictwo Literackie', 2007, 'Ksiazka drukowana', 'L-TOK-003', 'adult', NOW(), NOW()),
(100, 'Niezwyciezony', NULL, 3, 1, 2, 0, 1, 'Powieść science fiction o spotkaniu z obca, ewolucyjna inteligencja.', 'Wydawnictwo Literackie', 1964, 'Ksiazka drukowana', 'SF-LEM-003', 'adult', NOW(), NOW());
...
-- Dodatkowe egzemplarze dla nowych tytulow
INSERT INTO book_copy (id, book_id, inventory_code, status, location, access_type, condition_state, created_at, updated_at) VALUES
(31, 31, 'INV-031-001', 'AVAILABLE', 'Półka dzieci', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(32, 31, 'INV-031-002', 'AVAILABLE', 'Półka klasyka', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(33, 31, 'INV-031-003', 'BORROWED', 'Wypożyczona', 'STORAGE', 'Dobry', NOW(), NOW()),
(34, 32, 'INV-032-001', 'AVAILABLE', 'Półka literatura', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(35, 32, 'INV-032-002', 'AVAILABLE', 'Magazyn L2', 'STORAGE', 'Dobry', NOW(), NOW()),
(36, 32, 'INV-032-003', 'RESERVED', 'Rezerwacja', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(37, 33, 'INV-033-001', 'AVAILABLE', 'Półka fantasy', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(38, 33, 'INV-033-002', 'BORROWED', 'Wypożyczona', 'STORAGE', 'Dobry', NOW(), NOW()),
(39, 34, 'INV-034-001', 'AVAILABLE', 'Półka literatura', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(40, 34, 'INV-034-002', 'AVAILABLE', 'Półka literatura', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(41, 34, 'INV-034-003', 'AVAILABLE', 'Półka literatura', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(42, 34, 'INV-034-004', 'BORROWED', 'Wypożyczona', 'STORAGE', 'Dobry', NOW(), NOW()),
(43, 35, 'INV-035-001', 'AVAILABLE', 'Półka nowości', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(44, 35, 'INV-035-002', 'AVAILABLE', 'Półka nowości', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(45, 35, 'INV-035-003', 'BORROWED', 'Wypożyczona', 'STORAGE', 'Dobry', NOW(), NOW()),
(46, 36, 'INV-036-001', 'AVAILABLE', 'Półka literatura', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(47, 36, 'INV-036-002', 'BORROWED', 'Wypożyczona', 'STORAGE', 'Dobry', NOW(), NOW()),
(48, 37, 'INV-037-001', 'AVAILABLE', 'Półka fantasy', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(49, 37, 'INV-037-002', 'AVAILABLE', 'Półka fantasy', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(50, 37, 'INV-037-003', 'BORROWED', 'Wypożyczona', 'STORAGE', 'Dobry', NOW(), NOW()),
(51, 38, 'INV-038-001', 'AVAILABLE', 'Półka klasyka', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(52, 38, 'INV-038-002', 'AVAILABLE', 'Magazyn K1', 'STORAGE', 'Sredni', NOW(), NOW()),
(53, 38, 'INV-038-003', 'BORROWED', 'Wypożyczona', 'STORAGE', 'Dobry', NOW(), NOW()),
(54, 39, 'INV-039-001', 'AVAILABLE', 'Półka historia', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(55, 39, 'INV-039-002', 'BORROWED', 'Wypożyczona', 'STORAGE', 'Dobry', NOW(), NOW()),
(56, 40, 'INV-040-001', 'AVAILABLE', 'Półka fantasy', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(57, 40, 'INV-040-002', 'AVAILABLE', 'Półka fantasy', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(58, 40, 'INV-040-003', 'AVAILABLE', 'Półka fantasy', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(59, 40, 'INV-040-004', 'BORROWED', 'Wypożyczona', 'STORAGE', 'Dobry', NOW(), NOW());

WITH extra_copy_seed(book_id, shelf_name, primary_condition) AS (
    VALUES
    (41, 'Regal romans', 'Dobry'),
    (42, 'Regal fantasy', 'Bardzo dobry'),
    (43, 'Regal fantasy', 'Bardzo dobry'),
    (44, 'Regal fantasy', 'Dobry'),
    (45, 'Regal SF', 'Dobry'),
    (46, 'Regal literatura', 'Bardzo dobry'),
    (47, 'Regal kryminal', 'Dobry'),
    (48, 'Regal horror', 'Dobry'),
    (49, 'Regal literatura', 'Bardzo dobry'),
    (50, 'Regal thriller', 'Dobry'),
    (51, 'Regal thriller', 'Dobry'),
    (52, 'Regal popularnonaukowy', 'Bardzo dobry'),
    (53, 'Regal SF', 'Dobry'),
    (54, 'Regal kryminal', 'Bardzo dobry'),
    (55, 'Regal fantasy', 'Dobry'),
    (56, 'Regal fantasy', 'Dobry'),
    (57, 'Regal fantasy', 'Bardzo dobry'),
    (58, 'Regal fantasy', 'Dobry'),
    (59, 'Regal SF', 'Dobry'),
    (60, 'Regal SF', 'Bardzo dobry'),
    (61, 'Regal literatura', 'Dobry'),
    (62, 'Regal klasyka', 'Dobry'),
    (63, 'Regal klasyka', 'Bardzo dobry'),
    (64, 'Regal romans', 'Dobry'),
    (65, 'Regal kryminal', 'Dobry'),
    (66, 'Regal horror', 'Dobry'),
    (67, 'Regal literatura', 'Bardzo dobry'),
    (68, 'Regal fantasy', 'Dobry'),
    (69, 'Regal thriller', 'Dobry'),
    (70, 'Regal fantasy', 'Bardzo dobry'),
    (71, 'Regal literatura', 'Dobry'),
    (72, 'Regal thriller', 'Bardzo dobry'),
    (73, 'Regal klasyka', 'Dobry'),
    (74, 'Regal SF', 'Dobry'),
    (75, 'Regal reportaz', 'Bardzo dobry'),
    (76, 'Regal SF', 'Dobry'),
    (77, 'Regal SF', 'Dobry'),
    (78, 'Regal fantasy', 'Bardzo dobry'),
    (79, 'Regal fantasy', 'Dobry'),
    (80, 'Regal SF', 'Dobry'),
    (81, 'Regal thriller', 'Dobry'),
    (82, 'Regal popularnonaukowy', 'Bardzo dobry'),
    (83, 'Regal klasyka', 'Dobry'),
    (84, 'Regal historia', 'Dobry'),
    (85, 'Regal historia', 'Dobry'),
    (86, 'Regal literatura', 'Bardzo dobry'),
    (87, 'Regal poezja', 'Dobry'),
    (88, 'Regal reportaz', 'Dobry'),
    (89, 'Regal filozofia', 'Bardzo dobry'),
    (90, 'Regal fantasy', 'Dobry'),
    (91, 'Regal dzieci', 'Bardzo dobry'),
    (92, 'Regal fantasy', 'Bardzo dobry'),
    (93, 'Regal fantasy', 'Dobry'),
    (94, 'Regal fantasy', 'Dobry'),
    (95, 'Regal literatura', 'Bardzo dobry'),
    (96, 'Regal thriller', 'Dobry'),
    (97, 'Regal thriller', 'Dobry'),
    (98, 'Regal kryminal', 'Bardzo dobry'),
    (99, 'Regal literatura', 'Dobry'),
    (100, 'Regal SF', 'Dobry')
)
INSERT INTO book_copy (id, book_id, inventory_code, status, location, access_type, condition_state, created_at, updated_at)
SELECT
    59 + ROW_NUMBER() OVER (ORDER BY seed.book_id, copy_no) AS id,
    seed.book_id,
    'INV-' || LPAD(seed.book_id::text, 3, '0') || '-' || LPAD(copy_no::text, 3, '0') AS inventory_code,
    CASE WHEN copy_no = 1 THEN 'AVAILABLE' ELSE 'BORROWED' END AS status,
    CASE WHEN copy_no = 1 THEN seed.shelf_name ELSE 'Wypozyczona' END AS location,
    CASE WHEN copy_no = 1 THEN 'OPEN_STACK' ELSE 'STORAGE' END AS access_type,
    CASE WHEN copy_no = 1 THEN seed.primary_condition ELSE 'Dobry' END AS condition_state,
    NOW(),
    NOW()
FROM extra_copy_seed seed
CROSS JOIN generate_series(1, 2) AS copy_no;
