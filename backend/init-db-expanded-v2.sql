...
-- ============================================
-- PeĹ‚na struktura bazy danych systemu bibliotecznego
-- Data aktualizacji: 2025-12-13 12:00
-- System: Biblioteka - System ZarzÄ…dzania BibliotekÄ…
-- Wersja: 2.1.0
-- 
-- FUNKCJONALNOĹšCI:
...
-- - Onboarding uĹĽytkownika (preferred_categories)
-- - SzczegĂłĹ‚owy profil uĹĽytkownika (pesel, card_number, address)
-- - System kar finansowych (fine)
-- - Audyt aktywnoĹ›ci (audit_logs)
-- - WypoĹĽyczenia z przedĹ‚uĹĽeniami (loan)
...
-- Tabela: app_user - UĹĽytkownicy systemu
...
-- Tabela: author - Autorzy ksiÄ…ĹĽek
CREATE TABLE author (
    id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    name VARCHAR(255) NOT NULL,
    PRIMARY KEY(id)
...
-- Tabela: category - Kategorie ksiÄ…ĹĽek
...
-- Tabela: age_range - PrzedziaĹ‚y wiekowe (do rekomendacji)
...
-- Tabela: book_category - Relacja wiele do wielu miÄ™dzy ksiÄ…ĹĽkami a kategoriami
...
-- Tabela: book_copy - Egzemplarze ksiÄ…ĹĽek
...
-- Tabela: book_digital_asset - Zasoby cyfrowe ksiÄ…ĹĽek
...
-- Tabela: recommendation_feedback - Feedback uĹĽytkownika na rekomendacje
...
-- Tabela: collection_books - Relacja wiele do wielu miÄ™dzy kolekcjami a ksiÄ…ĹĽkami
...
-- ============================================
-- WYPOĹ»YCZENIA I REZERWACJE
-- ============================================

-- Tabela: loan - WypoĹĽyczenia
CREATE TABLE loan (
    id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
-- ============================================
-- MODUĹ UĹ»YTKOWNIKĂ“W
-- ============================================

-- Tabela: favorite - Ulubione ksiÄ…ĹĽki uĹĽytkownikĂłw
...
-- ============================================
-- MODUĹ ADMINISTRACYJNY
-- ============================================

-- Tabela: announcement - OgĹ‚oszenia
...
-- Tabela: notification_log - Logi powiadomieĹ„
...
-- Tabela: acquisition_budget - BudĹĽety akwizycji
...
-- Tabela: acquisition_order - ZamĂłwienia akwizycyjne
...
-- Tabela: weeding_record - Rekordy selekcji zbiorĂłw
...
-- PrzedziaĹ‚y wiekowe (do profilu czytelnika i dopasowania do book.target_age_group)
INSERT INTO age_range (code, label, min_age, max_age, description) VALUES
('child',  'Dzieci (0â€“12)', 0, 12, 'Czytelnicy dzieciÄ™cy'),
('teen',   'MĹ‚odzieĹĽ (13â€“17)', 13, 17, 'Czytelnicy mĹ‚odzieĹĽowi'),
('adult',  'DoroĹ›li (18â€“64)', 18, 64, 'Czytelnicy doroĹ›li'),
...
(4, 'user04@example.com', 'Maria Czytelnik', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48821834232', 'ul. Czytelnicza 4', 'KrakĂłw', '93-572', '91022225867', 'CARD-00004', false, false, NULL, false, 'student', 'teen', 10, NULL, NOW() - INTERVAL '83 days', NOW(), NOW(), true, '[16,29,30]', false),
(5, 'user05@example.com', 'Piotr WiĹ›niewski', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', NULL, 'ul. Czytelnicza 5', 'GdaĹ„sk', '83-455', '73102218531', 'CARD-00005', false, true, NOW() - INTERVAL '22 days', false, 'premium', 'teen', 15, NULL, NOW() - INTERVAL '506 days', NOW(), NOW(), true, '[2,5,20,28]', true),
(6, 'user06@example.com', 'Katarzyna WĂłjcik', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48892770813', 'ul. Czytelnicza 6', 'WrocĹ‚aw', '46-569', '70061949249', 'CARD-00006', false, true, NOW() - INTERVAL '9 days', false, 'standard', 'teen', 5, NULL, NOW() - INTERVAL '448 days', NOW(), NOW(), false, '[8,27]', true),
(7, 'user07@example.com', 'Tomasz Kowalczyk', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48658946996', 'ul. Czytelnicza 7', 'PoznaĹ„', '24-823', '98092567526', 'CARD-00007', false, true, NOW() - INTERVAL '65 days', false, 'student', 'teen', 10, NULL, NOW() - INTERVAL '85 days', NOW(), NOW(), true, '[3,10,29]', false),
(8, 'user08@example.com', 'Agnieszka KamiĹ„ska', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48888233424', 'ul. Czytelnicza 8', 'ĹĂłdĹş', '72-711', '96102021622', 'CARD-00008', false, false, NULL, true, 'premium', 'teen', 15, NULL, NOW() - INTERVAL '336 days', NOW(), NOW(), true, '[6,12,22,23]', true),
(9, 'user09@example.com', 'PaweĹ‚ Lewandowski', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48753195262', 'ul. Czytelnicza 9', 'Szczecin', '66-858', '71041513474', 'CARD-00009', false, true, NOW() - INTERVAL '67 days', false, 'standard', 'teen', 5, NULL, NOW() - INTERVAL '398 days', NOW(), NOW(), true, '[2,24]', true),
(10, 'user10@example.com', 'Magdalena ZieliĹ„ska', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', NULL, 'ul. Czytelnicza 10', 'Katowice', '80-973', '76012173587', 'CARD-00010', false, true, NOW() - INTERVAL '106 days', false, 'student', 'teen', 10, NULL, NOW() - INTERVAL '438 days', NOW(), NOW(), true, '[4,20,24]', false),
(11, 'user11@example.com', 'MichaĹ‚ SzymaĹ„ski', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48643743859', 'ul. Czytelnicza 11', 'Lublin', '76-711', '72062832251', 'CARD-00011', false, true, NOW() - INTERVAL '90 days', false, 'premium', 'child', 15, NULL, NOW() - INTERVAL '277 days', NOW(), NOW(), true, '[7,14,21,29]', true),
(12, 'user12@example.com', 'Joanna WoĹşniak', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48738967621', 'ul. Czytelnicza 12', 'BiaĹ‚ystok', '28-285', '77010525065', 'CARD-00012', false, false, NULL, false, 'standard', 'child', 5, NULL, NOW() - INTERVAL '394 days', NOW(), NOW(), false, '[13,16]', true),
(13, 'user13@example.com', 'Krzysztof DÄ…browski', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48733021385', 'ul. Czytelnicza 13', 'Warszawa', '75-624', '81021169893', 'CARD-00013', false, true, NOW() - INTERVAL '11 days', false, 'student', 'child', 10, NULL, NOW() - INTERVAL '517 days', NOW(), NOW(), true, '[23,25,29]', false),
(14, 'user14@example.com', 'Monika KozĹ‚owska', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48541486973', 'ul. Czytelnicza 14', 'KrakĂłw', '23-707', '94021169073', 'CARD-00014', false, true, NOW() - INTERVAL '67 days', false, 'premium', 'child', 15, NULL, NOW() - INTERVAL '562 days', NOW(), NOW(), true, '[1,3,14,28]', true),
(15, 'user15@example.com', 'Ĺukasz Jankowski', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', NULL, 'ul. Czytelnicza 15', 'GdaĹ„sk', '31-878', '98122640219', 'CARD-00015', false, true, NOW() - INTERVAL '55 days', false, 'standard', 'child', 5, NULL, NOW() - INTERVAL '575 days', NOW(), NOW(), true, '[8,11]', true),
(16, 'user16@example.com', 'Natalia Mazur', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48611554339', 'ul. Czytelnicza 16', 'WrocĹ‚aw', '78-849', '97122486675', 'CARD-00016', false, false, NULL, true, 'student', 'adult', 10, NULL, NOW() - INTERVAL '389 days', NOW(), NOW(), true, '[14,16,21]', false),
(17, 'user17@example.com', 'Marcin Krawczyk', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48719544823', 'ul. Czytelnicza 17', 'PoznaĹ„', '62-257', '79041013866', 'CARD-00017', true, true, NOW() - INTERVAL '74 days', false, 'premium', 'adult', 15, 'NieopĹ‚acone kary', NOW() - INTERVAL '547 days', NOW(), NOW(), true, '[10,27]', true),
(18, 'user18@example.com', 'Aleksandra Piotrowska', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48741997838', 'ul. Czytelnicza 18', 'ĹĂłdĹş', '14-419', '77040652408', 'CARD-00018', false, true, NOW() - INTERVAL '120 days', false, 'standard', 'adult', 5, NULL, NOW() - INTERVAL '444 days', NOW(), NOW(), false, '[12,15]', true),
...
(22, 'user22@example.com', 'Karolina KrĂłl', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48502692841', 'ul. Czytelnicza 22', 'BiaĹ‚ystok', '83-811', '81082853114', 'CARD-00022', false, true, NOW() - INTERVAL '114 days', false, 'student', 'adult', 10, NULL, NOW() - INTERVAL '243 days', NOW(), NOW(), true, '[3,10,15]', false),
(23, 'user23@example.com', 'RafaĹ‚ Wieczorek', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48735884072', 'ul. Czytelnicza 23', 'Warszawa', '93-747', '89030884195', 'CARD-00023', false, true, NOW() - INTERVAL '106 days', false, 'premium', 'adult', 15, NULL, NOW() - INTERVAL '452 days', NOW(), NOW(), true, '[10,15,19,25]', true),
(24, 'user24@example.com', 'Weronika JabĹ‚oĹ„ska', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48564787143', 'ul. Czytelnicza 24', 'KrakĂłw', '90-342', '76040435843', 'CARD-00024', false, false, NULL, true, 'standard', 'adult', 5, NULL, NOW() - INTERVAL '239 days', NOW(), NOW(), false, '[5,12]', true),
(25, 'user25@example.com', 'Mateusz Nowicki', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', NULL, 'ul. Czytelnicza 25', 'GdaĹ„sk', '11-761', '78020223882', 'CARD-00025', false, true, NOW() - INTERVAL '91 days', false, 'student', 'adult', 10, NULL, NOW() - INTERVAL '549 days', NOW(), NOW(), true, '[12,17,30]', false),
(26, 'user26@example.com', 'Julia Maj', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48894061181', 'ul. Czytelnicza 26', 'WrocĹ‚aw', '21-720', '82050739503', 'CARD-00026', false, true, NOW() - INTERVAL '100 days', false, 'premium', 'adult', 15, NULL, NOW() - INTERVAL '413 days', NOW(), NOW(), true, '[12,15,25,29]', true),
(27, 'user27@example.com', 'Bartosz Ostrowski', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48508008844', 'ul. Czytelnicza 27', 'PoznaĹ„', '47-274', '99112326556', 'CARD-00027', false, true, NOW() - INTERVAL '91 days', false, 'standard', 'adult', 5, NULL, NOW() - INTERVAL '196 days', NOW(), NOW(), true, '[6,28]', true),
(28, 'user28@example.com', 'Ewa GĂłrska', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48505094687', 'ul. Czytelnicza 28', 'ĹĂłdĹş', '86-571', '80012533403', 'CARD-00028', false, false, NULL, false, 'student', 'senior', 10, NULL, NOW() - INTERVAL '15 days', NOW(), NOW(), true, '[9,14,24]', false),
(29, 'user29@example.com', 'Patryk Kubiak', '["ROLE_USER"]', '$2y$13$Xhz8P0vQ.zKL9XGkYPfcReZE8QYj1MJOvGk.W7nRZ7I8x5YqzLVnm', '+48738559209', 'ul. Czytelnicza 29', 'Szczecin', '82-774', '82041017608', 'CARD-00029', true, true, NOW() - INTERVAL '73 days', false, 'premium', 'senior', 15, 'NieopĹ‚acone kary', NOW() - INTERVAL '428 days', NOW(), NOW(), true, '[7,9,20]', true),
...
(2, 'Olga Tokarczuk'),
(3, 'StanisĹ‚aw Lem'),
(4, 'Ryszard KapuĹ›ciĹ„ski'),
(5, 'WisĹ‚awa Szymborska'),
...
-- Relacje ksiÄ…ĹĽka-kategoria (30)
...
-- Dodatkowe kategorie dla ksiÄ…ĹĽek (Ĺ›rednio 2â€“4 kategorie na tytuĹ‚)
INSERT INTO book_category (book_id, category_id) VALUES
(1, 5),
(2, 8),
(2, 30),
...
(2, 1, 'INV-001-002', 'AVAILABLE', 'PĂłĹ‚ka gĹ‚Ăłwna', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(3, 1, 'INV-001-003', 'BORROWED', 'WypoĹĽyczona', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(4, 2, 'INV-002-001', 'AVAILABLE', 'Magazyn B2', 'STORAGE', 'Dobry', NOW(), NOW()),
(5, 3, 'INV-003-001', 'AVAILABLE', 'PĂłĹ‚ka SF', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(6, 3, 'INV-003-002', 'AVAILABLE', 'PĂłĹ‚ka SF', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(7, 8, 'INV-008-001', 'AVAILABLE', 'Cyfrowy', 'REFERENCE', 'Nieaplikowalny', NOW(), NOW()),
(8, 9, 'INV-009-001', 'AVAILABLE', 'PĂłĹ‚ka dystopie', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(9, 10, 'INV-010-001', 'BORROWED', 'WypoĹĽyczona', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(10, 10, 'INV-010-002', 'AVAILABLE', 'PĂłĹ‚ka SF', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
...
(13, 11, 'INV-011-001', 'AVAILABLE', 'PĂłĹ‚ka klasyka', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(14, 12, 'INV-012-001', 'BORROWED', 'WypoĹĽyczona', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(15, 13, 'INV-013-001', 'AVAILABLE', 'PĂłĹ‚ka literatura', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(16, 14, 'INV-014-001', 'RESERVED', 'Rezerwacja', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(17, 15, 'INV-015-001', 'AVAILABLE', 'PĂłĹ‚ka SF', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(18, 16, 'INV-016-001', 'BORROWED', 'WypoĹĽyczona', 'STORAGE', 'Dobry', NOW(), NOW()),
(19, 17, 'INV-017-001', 'AVAILABLE', 'PĂłĹ‚ka dystopie', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(20, 18, 'INV-018-001', 'MAINTENANCE', 'Konserwacja', 'STORAGE', 'ZuĹĽyty', NOW(), NOW()),
(21, 19, 'INV-019-001', 'AVAILABLE', 'PĂłĹ‚ka kryminaĹ‚', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(22, 20, 'INV-020-001', 'BORROWED', 'WypoĹĽyczona', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(23, 21, 'INV-021-001', 'AVAILABLE', 'PĂłĹ‚ka klasyka', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
...
(26, 24, 'INV-024-001', 'AVAILABLE', 'PĂłĹ‚ka SF', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(27, 27, 'INV-027-001', 'AVAILABLE', 'Cyfrowy', 'REFERENCE', 'Nieaplikowalny', NOW(), NOW()),
(28, 25, 'INV-025-001', 'AVAILABLE', 'PĂłĹ‚ka fantasy', 'OPEN_STACK', 'Bardzo dobry', NOW(), NOW()),
(29, 26, 'INV-026-001', 'BORROWED', 'WypoĹĽyczona', 'OPEN_STACK', 'Dobry', NOW(), NOW()),
(30, 30, 'INV-030-001', 'AVAILABLE', 'PĂłĹ‚ka psychologia', 'OPEN_STACK', 'Dobry', NOW(), NOW());
...
(4, 'Spis treĹ›ci', 'book_05_spis_treĹ›ci.pdf', 'application/pdf', 12950947, 'asset_004_5270c475a5.pdf', NOW(), 5),
(5, 'OkĹ‚adka', 'book_06_okĹ‚adka.jpg', 'image/jpeg', 6882383, 'asset_005_34ffb55da2.jpg', NOW(), 6),
...
(9, 'Spis treĹ›ci', 'book_10_spis_treĹ›ci.pdf', 'application/pdf', 14727140, 'asset_009_a01107e3d8.pdf', NOW(), 10),
(10, 'OkĹ‚adka', 'book_11_okĹ‚adka.jpg', 'image/jpeg', 690112, 'asset_010_dacfe45b1c.jpg', NOW(), 11),
...
(14, 'Spis treĹ›ci', 'book_15_spis_treĹ›ci.pdf', 'application/pdf', 5623352, 'asset_014_f2b1506c96.pdf', NOW(), 15),
(15, 'OkĹ‚adka', 'book_16_okĹ‚adka.jpg', 'image/jpeg', 5767645, 'asset_015_deb343d706.jpg', NOW(), 16),
...
(19, 'Spis treĹ›ci', 'book_20_spis_treĹ›ci.pdf', 'application/pdf', 2315888, 'asset_019_b08044bc3a.pdf', NOW(), 20),
(20, 'OkĹ‚adka', 'book_21_okĹ‚adka.jpg', 'image/jpeg', 5707556, 'asset_020_68160881ab.jpg', NOW(), 21),
...
(24, 'Spis treĹ›ci', 'book_25_spis_treĹ›ci.pdf', 'application/pdf', 4163158, 'asset_024_c62b170d2b.pdf', NOW(), 25),
(25, 'OkĹ‚adka', 'book_26_okĹ‚adka.jpg', 'image/jpeg', 2797719, 'asset_025_fded8d59d3.jpg', NOW(), 26),
...
(29, 'Spis treĹ›ci', 'book_30_spis_treĹ›ci.pdf', 'application/pdf', 1519910, 'asset_029_ece932ecc4.pdf', NOW(), 30),
(30, 'OkĹ‚adka', 'book_01_okĹ‚adka.jpg', 'image/jpeg', 14790970, 'asset_030_dd7bb1073d.jpg', NOW(), 1);
...
(1, 11.61, 'PLN', 'OpĹ‚ata administracyjna', NOW() - INTERVAL '43 days', NULL, 1),
(2, 40.76, 'PLN', 'Uszkodzenie egzemplarza', NOW() - INTERVAL '23 days', NULL, 2),
(3, 19.74, 'PLN', 'Przetrzymanie', NOW() - INTERVAL '53 days', NULL, 3),
(4, 19.39, 'PLN', 'Zgubienie ksiÄ…ĹĽki', NOW() - INTERVAL '22 days', NOW() - INTERVAL '27 days', 4),
(5, 28.39, 'PLN', 'Zgubienie ksiÄ…ĹĽki', NOW() - INTERVAL '8 days', NULL, 5),
(6, 46.16, 'PLN', 'Przetrzymanie', NOW() - INTERVAL '33 days', NULL, 6),
(7, 25.64, 'PLN', 'Zgubienie ksiÄ…ĹĽki', NOW() - INTERVAL '7 days', NULL, 7),
(8, 47.27, 'PLN', 'Przetrzymanie', NOW() - INTERVAL '75 days', NOW() - INTERVAL '12 days', 8),
(9, 15.63, 'PLN', 'OpĹ‚ata administracyjna', NOW() - INTERVAL '73 days', NULL, 9),
(10, 38.51, 'PLN', 'Zgubienie ksiÄ…ĹĽki', NOW() - INTERVAL '31 days', NULL, 10),
(11, 32.69, 'PLN', 'Zgubienie ksiÄ…ĹĽki', NOW() - INTERVAL '56 days', NULL, 11),
(12, 28.58, 'PLN', 'Zgubienie ksiÄ…ĹĽki', NOW() - INTERVAL '31 days', NOW() - INTERVAL '30 days', 12),
(13, 34.83, 'PLN', 'Zgubienie ksiÄ…ĹĽki', NOW() - INTERVAL '43 days', NULL, 13),
(14, 47.79, 'PLN', 'Uszkodzenie egzemplarza', NOW() - INTERVAL '15 days', NULL, 14),
(15, 1.98, 'PLN', 'OpĹ‚ata administracyjna', NOW() - INTERVAL '16 days', NULL, 15),
(16, 24.39, 'PLN', 'Przetrzymanie', NOW() - INTERVAL '60 days', NOW() - INTERVAL '17 days', 16),
(17, 7.94, 'PLN', 'Zgubienie ksiÄ…ĹĽki', NOW() - INTERVAL '28 days', NULL, 17),
(18, 30.29, 'PLN', 'Przetrzymanie', NOW() - INTERVAL '59 days', NULL, 18),
(19, 25.7, 'PLN', 'Zgubienie ksiÄ…ĹĽki', NOW() - INTERVAL '90 days', NULL, 19),
...
(22, 14.97, 'PLN', 'OpĹ‚ata administracyjna', NOW() - INTERVAL '45 days', NULL, 22),
...
(26, 25.49, 'PLN', 'OpĹ‚ata administracyjna', NOW() - INTERVAL '28 days', NULL, 26),
(27, 14.84, 'PLN', 'Przetrzymanie', NOW() - INTERVAL '13 days', NULL, 27),
(28, 22.69, 'PLN', 'Zgubienie ksiÄ…ĹĽki', NOW() - INTERVAL '24 days', NOW() - INTERVAL '16 days', 28),
(29, 47.1, 'PLN', 'Przetrzymanie', NOW() - INTERVAL '81 days', NULL, 29),
(30, 47.03, 'PLN', 'OpĹ‚ata administracyjna', NOW() - INTERVAL '57 days', NULL, 30);
...
(1, 'OgĹ‚oszenie #01', 'TreĹ›Ä‡ ogĹ‚oszenia #01 (dane testowe).', 'event', 'draft', true, true, NOW() - INTERVAL '17 days', NOW() - INTERVAL '17 days', NULL, NULL, NOW() + INTERVAL '10 days', '["all"]', 2),
(2, 'OgĹ‚oszenie #02', 'TreĹ›Ä‡ ogĹ‚oszenia #02 (dane testowe).', 'maintenance', 'archived', true, true, NOW() - INTERVAL '108 days', NOW() - INTERVAL '108 days', NULL, NULL, NULL, '["all"]', 2),
(3, 'OgĹ‚oszenie #03', 'TreĹ›Ä‡ ogĹ‚oszenia #03 (dane testowe).', 'policy', 'published', true, true, NOW() - INTERVAL '110 days', NOW() - INTERVAL '110 days', NOW() - INTERVAL '110 days', NOW() + INTERVAL '10 days', NULL, '["all"]', 2),
(4, 'OgĹ‚oszenie #04', 'TreĹ›Ä‡ ogĹ‚oszenia #04 (dane testowe).', 'info', 'draft', false, true, NOW() - INTERVAL '20 days', NOW() - INTERVAL '20 days', NULL, NULL, NULL, '["ROLE_USER"]', 2),
(5, 'OgĹ‚oszenie #05', 'TreĹ›Ä‡ ogĹ‚oszenia #05 (dane testowe).', 'event', 'archived', false, true, NOW() - INTERVAL '100 days', NOW() - INTERVAL '100 days', NULL, NULL, NOW() + INTERVAL '13 days', '["all"]', 2),
(6, 'OgĹ‚oszenie #06', 'TreĹ›Ä‡ ogĹ‚oszenia #06 (dane testowe).', 'maintenance', 'published', false, true, NOW() - INTERVAL '101 days', NOW() - INTERVAL '101 days', NOW() - INTERVAL '101 days', NOW() + INTERVAL '21 days', NULL, '["ROLE_LIBRARIAN","ROLE_ADMIN"]', 2),
(7, 'OgĹ‚oszenie #07', 'TreĹ›Ä‡ ogĹ‚oszenia #07 (dane testowe).', 'policy', 'draft', false, true, NOW() - INTERVAL '42 days', NOW() - INTERVAL '42 days', NULL, NULL, NULL, '["all"]', 1),
(8, 'OgĹ‚oszenie #08', 'TreĹ›Ä‡ ogĹ‚oszenia #08 (dane testowe).', 'info', 'archived', false, true, NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days', NULL, NULL, NULL, '["ROLE_USER"]', 2),
(9, 'OgĹ‚oszenie #09', 'TreĹ›Ä‡ ogĹ‚oszenia #09 (dane testowe).', 'event', 'published', false, true, NOW() - INTERVAL '12 days', NOW() - INTERVAL '12 days', NOW() - INTERVAL '12 days', NOW() + INTERVAL '28 days', NOW() + INTERVAL '16 days', '["all"]', 2),
(10, 'OgĹ‚oszenie #10', 'TreĹ›Ä‡ ogĹ‚oszenia #10 (dane testowe).', 'maintenance', 'draft', false, true, NOW() - INTERVAL '28 days', NOW() - INTERVAL '28 days', NULL, NULL, NULL, '["all"]', 2),
(11, 'OgĹ‚oszenie #11', 'TreĹ›Ä‡ ogĹ‚oszenia #11 (dane testowe).', 'policy', 'archived', false, false, NOW() - INTERVAL '58 days', NOW() - INTERVAL '58 days', NULL, NULL, NULL, '["all"]', 2),
(12, 'OgĹ‚oszenie #12', 'TreĹ›Ä‡ ogĹ‚oszenia #12 (dane testowe).', 'info', 'published', false, false, NOW() - INTERVAL '55 days', NOW() - INTERVAL '55 days', NOW() - INTERVAL '55 days', NOW() + INTERVAL '35 days', NULL, '["ROLE_USER"]', 2),
(13, 'OgĹ‚oszenie #13', 'TreĹ›Ä‡ ogĹ‚oszenia #13 (dane testowe).', 'event', 'draft', false, false, NOW() - INTERVAL '84 days', NOW() - INTERVAL '84 days', NULL, NULL, NOW() + INTERVAL '19 days', '["all"]', 2),
(14, 'OgĹ‚oszenie #14', 'TreĹ›Ä‡ ogĹ‚oszenia #14 (dane testowe).', 'maintenance', 'archived', false, false, NOW() - INTERVAL '51 days', NOW() - INTERVAL '51 days', NULL, NULL, NULL, '["all"]', 1),
(15, 'OgĹ‚oszenie #15', 'TreĹ›Ä‡ ogĹ‚oszenia #15 (dane testowe).', 'policy', 'published', false, true, NOW() - INTERVAL '7 days', NOW() - INTERVAL '7 days', NOW() - INTERVAL '7 days', NOW() + INTERVAL '17 days', NULL, '["all"]', 2),
(16, 'OgĹ‚oszenie #16', 'TreĹ›Ä‡ ogĹ‚oszenia #16 (dane testowe).', 'info', 'draft', false, false, NOW() - INTERVAL '19 days', NOW() - INTERVAL '19 days', NULL, NULL, NULL, '["ROLE_USER"]', 2),
(17, 'OgĹ‚oszenie #17', 'TreĹ›Ä‡ ogĹ‚oszenia #17 (dane testowe).', 'event', 'archived', false, false, NOW() - INTERVAL '14 days', NOW() - INTERVAL '14 days', NULL, NULL, NOW() + INTERVAL '22 days', '["all"]', 2),
(18, 'OgĹ‚oszenie #18', 'TreĹ›Ä‡ ogĹ‚oszenia #18 (dane testowe).', 'maintenance', 'published', false, false, NOW() - INTERVAL '59 days', NOW() - INTERVAL '59 days', NOW() - INTERVAL '59 days', NOW() + INTERVAL '21 days', NULL, '["ROLE_LIBRARIAN","ROLE_ADMIN"]', 2),
(19, 'OgĹ‚oszenie #19', 'TreĹ›Ä‡ ogĹ‚oszenia #19 (dane testowe).', 'policy', 'draft', false, false, NOW() - INTERVAL '17 days', NOW() - INTERVAL '17 days', NULL, NULL, NULL, '["all"]', 2),
(20, 'OgĹ‚oszenie #20', 'TreĹ›Ä‡ ogĹ‚oszenia #20 (dane testowe).', 'info', 'archived', false, true, NOW() - INTERVAL '85 days', NOW() - INTERVAL '85 days', NULL, NULL, NULL, '["ROLE_USER"]', 2),
(21, 'OgĹ‚oszenie #21', 'TreĹ›Ä‡ ogĹ‚oszenia #21 (dane testowe).', 'event', 'published', false, false, NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days', NOW() + INTERVAL '55 days', NOW() + INTERVAL '25 days', '["all"]', 1),
(22, 'OgĹ‚oszenie #22', 'TreĹ›Ä‡ ogĹ‚oszenia #22 (dane testowe).', 'maintenance', 'draft', false, false, NOW() - INTERVAL '56 days', NOW() - INTERVAL '56 days', NULL, NULL, NULL, '["all"]', 2),
(23, 'OgĹ‚oszenie #23', 'TreĹ›Ä‡ ogĹ‚oszenia #23 (dane testowe).', 'policy', 'archived', false, false, NOW() - INTERVAL '103 days', NOW() - INTERVAL '103 days', NULL, NULL, NULL, '["all"]', 2),
(24, 'OgĹ‚oszenie #24', 'TreĹ›Ä‡ ogĹ‚oszenia #24 (dane testowe).', 'info', 'published', false, false, NOW() - INTERVAL '104 days', NOW() - INTERVAL '104 days', NOW() - INTERVAL '104 days', NOW() + INTERVAL '36 days', NULL, '["ROLE_USER"]', 2),
(25, 'OgĹ‚oszenie #25', 'TreĹ›Ä‡ ogĹ‚oszenia #25 (dane testowe).', 'event', 'draft', false, true, NOW() - INTERVAL '104 days', NOW() - INTERVAL '104 days', NULL, NULL, NOW() + INTERVAL '28 days', '["all"]', 2),
(26, 'OgĹ‚oszenie #26', 'TreĹ›Ä‡ ogĹ‚oszenia #26 (dane testowe).', 'maintenance', 'archived', false, false, NOW() - INTERVAL '30 days', NOW() - INTERVAL '30 days', NULL, NULL, NULL, '["all"]', 2),
(27, 'OgĹ‚oszenie #27', 'TreĹ›Ä‡ ogĹ‚oszenia #27 (dane testowe).', 'policy', 'published', false, false, NOW() - INTERVAL '30 days', NOW() - INTERVAL '30 days', NOW() - INTERVAL '30 days', NOW() + INTERVAL '65 days', NULL, '["all"]', 2),
(28, 'OgĹ‚oszenie #28', 'TreĹ›Ä‡ ogĹ‚oszenia #28 (dane testowe).', 'info', 'draft', false, false, NOW() - INTERVAL '43 days', NOW() - INTERVAL '43 days', NULL, NULL, NULL, '["ROLE_USER"]', 1),
(29, 'OgĹ‚oszenie #29', 'TreĹ›Ä‡ ogĹ‚oszenia #29 (dane testowe).', 'event', 'archived', false, false, NOW() - INTERVAL '85 days', NOW() - INTERVAL '85 days', NULL, NULL, NOW() + INTERVAL '31 days', '["all"]', 2),
(30, 'OgĹ‚oszenie #30', 'TreĹ›Ä‡ ogĹ‚oszenia #30 (dane testowe).', 'maintenance', 'published', false, true, NOW() - INTERVAL '18 days', NOW() - INTERVAL '18 days', NOW() - INTERVAL '18 days', NOW() + INTERVAL '21 days', NULL, '["ROLE_LIBRARIAN","ROLE_ADMIN"]', 2);
