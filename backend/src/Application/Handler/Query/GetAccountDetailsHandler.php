...
class GetAccountDetailsHandler
{
    ...
    public function __invoke(GetAccountDetailsQuery $query): array
    {
        ...
        return [
            ...
            'keepHistory' => $user->getKeepHistory(),
            'emailLoans' => $user->getEmailLoans(),
            'emailReservations' => $user->getEmailReservations(),
            'emailFines' => $user->getEmailFines(),
            'emailAnnouncements' => $user->getEmailAnnouncements(),
